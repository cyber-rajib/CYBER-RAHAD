...
const time = process.uptime() ,
  ...
  const loz = ["https://i.imgur.com/gO4Hc5c.jpg","https://i.imgur.com/gO4Hc5c.jpg","https://i.imgur.com/gO4Hc5c.jpg","https://i.imgur.com/gO4Hc5c.jpg","https://i.imgur.com/gO4Hc5c.jpg","https://i.imgur.com/gO4Hc5c.jpg","https://i.imgur.com/gO4Hc5c.jpg"]
...
let l1 = await loadImage(pathAva);
  ...
  ctx.drawImage(l1, 800, -160, 1100, 1100);
    ...
    ctx.font = "1111px phenomicon";
    ctx.fillStyle = lengthchar[id].colorBg;
    ctx.fillText("UPTIME ROBOT", 1111, 1111);
    ctx.beginPath();
  ////////////////////////////////////////
   registerFont(__dirname + `/tad/UTM-Avo.ttf`, {
    ...
    ctx.fillText(`${z_1} : ${x_1} : ${y_1} `, 80, 240);
    ctx.restore();
    ctx.save();
registerFont(__dirname + `/tad/CaviarDreams.ttf`, {
    ...
    ctx.textAlign = "start";
    ctx.left = "time";
    ctx.fillText("@" + "𝐌𝐝 𝐉𝐚𝐡𝐢𝐝 𝐇𝐚𝐬𝐚𝐧 𝐑𝐚𝐣𝐢𝐛", 350, 715)
    ctx.fillText("@" + "𝐌𝐝 𝐉𝐚𝐡𝐢𝐝 𝐇𝐚𝐬𝐚𝐧 𝐑𝐚𝐣𝐢𝐛", 350, 775)
   //ctx.fillText("@" + "DVFB.VietLe.pro", 205, 450)
    ctx.restore();
    ctx.save();
    ctx.beginPath();
