module.exports.config = {
  ...
  prefix: true,
  credits: "RAHAT",
  description: "Birthday Wish Your Bf Gf Mention",
  category: "WISH",
  usages: "BIRTHDAY💞",
  dependencies: {
...
a("- RAHAT KHAN এর পক্ষ থেকে তোমাকে জন্মদিনের শুভেচ্ছা\nHAPPY BIRTHDAY To You");
...
setTimeout(() => {a({body: "শুভ ন্মদিন শুভ হোক তোর আগামী দিন। তোমার এই মুখের হাসি যেন সারাজিবন এমনি থাকুক, হ্যাপি বার্থডে"})} , 26000);
